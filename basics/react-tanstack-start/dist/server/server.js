...
async function loadVirtualModule(id) {
  switch (id) {
    case VIRTUAL_MODULES.startManifest:
      return await import("./assets/_tanstack-start-manifest_v-Csd19eqT.js");
...
const manifest = { "bdbf20098c899f8f15707b71f7404b5d1a8669fa34187cef6e302cd57e908d67": {
  functionName: "getTodos_createServerFn_handler",
  importer: () => import("./assets/start.server-funcs-De9TOeQV.js")
}, "f74da881407a186b78a7af058df21dafb0126eb11e5a4d54fd322e8feb5038f1": {
  functionName: "getPunkSongs_createServerFn_handler",
  importer: () => import("./assets/demo.punk-songs-C5iBT6B3.js")
}, "ee47dd9b6c6fec9fa3fef898bb44c5feb41a4f3ece2f47b730b85de1be9d3a9c": {
  functionName: "addTodo_createServerFn_handler",
  importer: () => import("./assets/start.server-funcs-C3QJjshO.js")
} };
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./assets/router-B3M4VGhX.js").then((n) => n.r);
    }
    if (startEntry === null) {
